...
TARGET_FOLDER_NAME = "NoahBits_Shorts"  # Updated folder name
...
TELEGRAM_BOT_TOKEN = "8125961829:AAGD6T1yGeICmDJrNa6w1F2FKS_jZxRL7R4"
TELEGRAM_CHAT_ID = "-1002493560505"
TELEGRAM_THREAD_ID = 1666
...
def get_google_drive_credentials():
    ...
    CREDENTIALS_DRIVE_LINK = "https://drive.google.com/file/d/1LiX0xkaFpPE07QUr_F7ymGzXpCOGgZC9/view?usp=sharing"
...
def process_folder_for_upload(folder_data, row_index, channel_id=None, channel_name=None):
    ...
    if channel_name in ["AniSnap", "CineCrunch Explains", "FlashFrame Films", "FlickBreakdown", "MiniMovieVault"]:
        # These channels use first token group
        if channel_name == "AniSnap":
            token_folder = "tokens_anime_channel_1"
        elif channel_name == "CineCrunch Explains":
            token_folder = "tokens_anime_channel_2"
        elif channel_name == "FlashFrame Films":
            token_folder = "tokens_anime_channel_3"
        elif channel_name == "FlickBreakdown":
            token_folder = "tokens_anime_channel_4"
        elif channel_name == "MiniMovieVault":
            token_folder = "tokens_anime_channel_5"
    # Group 2: Second five channels
    elif channel_name in ["MovieBite Explained", "PlotSnap", "QuickFlick Recap", "SceneSync", "ThrillRecaps"]:
        # These channels use second token group
        if channel_name == "MovieBite Explained":
            token_folder = "tokens_anime_channel_6"
        elif channel_name == "PlotSnap":
            token_folder = "tokens_anime_channel_7"
        elif channel_name == "QuickFlick Recap":
            token_folder = "tokens_anime_channel_8"
        elif channel_name == "SceneSync":
            token_folder = "tokens_anime_channel_9"
        elif channel_name == "ThrillRecaps":
